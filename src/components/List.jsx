...
const List = (props) => {
  ...
  const handleButtonClick = () => {
    switch (props.label.toLowerCase()) {
      ...
      case "locations":
        window.open(
          "https://www.google.com/maps/place/HJP9%2B4VM+Kantor+desa+Winong+Kecamatan+Bawang,+Winong,+Kec.+Bawang,+Kab.+Banjarnegara,+Jawa+Tengah+53471/data=!4m2!3m1!1s0x2e7aab73210c7677:0x6efbff6f88979b1e?utm_source=mstt_1&entry=gps&lucs=,47075915&g_ep=CAESCjExLjExMi4xMDIYACDXggMqCSw0NzA3NTkxNUICSUQ%3D&hl=id",
          "_blank"
        );
        break;
      case "pricelist":
